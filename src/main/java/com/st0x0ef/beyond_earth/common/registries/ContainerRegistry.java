...
public class ContainerRegistry {
    ...
    public static final RegistryObject<MenuType<RocketUpgraderMenu.GuiContainer>> ROCKET_UPGRADER_GUI = CONTAINERS.register("rocket_upgrader_gui", () -> new MenuType<>(new RocketUpgraderMenu.GuiContainerFactory(), null));
