...
import com.st0x0ef.beyond_earth.common.menus.*;
...
public class ContainerRegistry {
    ...
    public static final RegistryObject<MenuType<WaterSeparatorMenu.GuiContainer>> water_separator_GUI = CONTAINERS.register("water_separator_gui", () -> new MenuType<>(new WaterSeparatorMenu.GuiContainerFactory(), null));
    ...
    public static final RegistryObject<MenuType<VehicleUpgraderMenu.GuiContainer>> VEHICLE_UPGRADER_GUI = CONTAINERS.register("vehcile_upgrader_gui", () -> new MenuType<>(new VehicleUpgraderMenu.GuiContainerFactory(), null));
