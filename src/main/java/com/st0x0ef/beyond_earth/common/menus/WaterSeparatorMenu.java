...
public class WaterSeparatorMenu {
    ...
    public static class GuiContainer extends AbstractContainerMenu {
        ...
        public GuiContainer(int id, Inventory inv, WaterSeparatorBlockEntity blockEntity) {
            ...
            this.addSlot(new SlotItemHandler(internal, OxygenMakingBlockEntity.SLOT_INPUT_SOURCE, 8, 31));
            this.addSlot(new SlotItemHandler(internal, OxygenMakingBlockEntity.SLOT_INPUT_SINK, 8, 61));
            this.addSlot(new SlotItemHandler(internal, WaterSeparatorBlockEntity.SLOT_INPUT_SOURCE_O2, 123, 31));
            this.addSlot(new SlotItemHandler(internal, WaterSeparatorBlockEntity.SLOT_OUTPUT_SINK_O2, 123, 61));
            this.addSlot(new SlotItemHandler(internal, WaterSeparatorBlockEntity.SLOT_INPUT_SOURCE_H2, 153, 31));
            this.addSlot(new SlotItemHandler(internal, WaterSeparatorBlockEntity.SLOT_OUTPUT_SINK_H2, 153, 61));
