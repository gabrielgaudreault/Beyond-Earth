...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    public ModBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, BeyondEarth.MODID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(BlockRegistry.RAW_URANIUM_BLOCK.get());
        ...
        simpleBlock(BlockRegistry.MERCURY_URANIUM_ORE.get());
        ...
        simpleBlock(BlockRegistry.GLACIO_URANIUM_ORE.get());
